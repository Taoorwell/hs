...
df4 = pd.read_excel(file_path, sheet_name='Time1')
...
def plot_1(result):
    ...
    C6 = mpatches.Patch(color='DeepSkyBlue', label='WCLD')
    C7 = mpatches.Patch(color='Cyan', label='GMLD')
...
#for i in range(0, 2):
 ...
 #       if (i == 0) & (j >= 2):
  #          print(i, j)
           # predicts, index = vectors_to_raster(vector_data_path=mat_path+l[j], 
